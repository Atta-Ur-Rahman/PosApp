...
public class CompleteJobsAdapter extends RecyclerView.Adapter<CompleteJobsAdapter.ViewHolder> {
    ...
    public CompleteJobsAdapter(List<PosHelper> posHelpers, Activity context) {
